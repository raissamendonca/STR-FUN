...
```{r Rsqr std error function & lm bootstrap, tidy=TRUE}
...
```{r Rsqr RDA bootstrap, tidy=TRUE}
...
|Treatment| R<sup>2</sup> | SE | R<sup>2</sup> *boot* | SE |
|:-:|:-:|:-:|:-:|:-:|
| Low-binding Big Pup | 0.0003 | 0.007 | 0.0004 | ? |
| Low-binding Salmon Trout | 0.005 | 0.025 | 0.005 | ? |
| High-binding Big Pup | 0.033 | 0.062 | 0.033 | ? |
| High-binding Salmon Trout | 0.602 | 0.109 | 0.602 | ? |

--------

*RDA models*

|Treatment| R<sup>2</sup> *boot* | Lower | Upper |
|:-:|:-:|:-:|:-:|
| Low-binding Big Pup | 0.11 | 0.04 | 0.16 |
| Low-binding Salmon Trout | 0.05 | 0.04 | 0.21 |
| High-binding Big Pup | 0.11 | 0.04 | 0.18 |
| High-binding Salmon Trout | 0.10 | 0.05 | 0.17 |